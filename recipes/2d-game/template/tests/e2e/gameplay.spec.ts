 ...
 * The Programmer agent must add a player element that exposes its horizontal
 * position via `data-testid="player"` + `data-x` attribute, and respond to
 * ArrowLeft / ArrowRight keys.
 *
 * See recipes/2d-game/prompts/programmer.md for the full contract.
 */
